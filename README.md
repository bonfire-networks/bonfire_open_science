...
```
cd extensions
git clone https://github.com/bonfire-networks/bonfire_open_science.git {your-extension-name-here}
cd {your-extension-name-here} 
```
- Rename all the modules names to match your extension name:
    - Find & replace Bonfire.OpenScience -> Bonfire.YourExtensionName 
    - Find & replace bonfire_open_science -> bonfire_your_extension_name
- Rename the `bonfire_open_science.exs` config file to match your extension name `bonfire_your_extension_name.exs`
...
- Add `use_if_enabled(Bonfire.OpenScience.Web.Routes)` in your app's `Router` module
...
declare_extension(
      ...
      icon: "bi:app",
      default_nav: [
        Bonfire.OpenScience.Web.HomeLive,
        Bonfire.OpenScience.Web.AboutLive
      ])
```
...
declare_nav_link(l("About"),
    page: "About",
    href: "/bonfire_open_science/about",
